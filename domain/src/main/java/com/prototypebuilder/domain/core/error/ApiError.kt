 ...
 */
package com.simpleenergy.domain.core.error
...
const val NO_INTERNET_ERROR_MESSAGE = "There is no Internet Connection"
const val APOLLO_API_ERROR = "Something went wrong! Please try again in some time"
...
data class ApiError(val message: String?, val code: Int?, var errorStatus: ErrorStatus) {
    ...
    fun getErrorMessage(): String {
        return when (errorStatus) {
            ...
            ErrorStatus.APOLLO_API_ERROR -> APOLLO_API_ERROR
        }
    }
